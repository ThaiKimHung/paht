...
class PlayVideo extends Component {
        ...
        return (
            <View style={[nstyles.nrow, {
                ...
                <TouchableOpacity activeOpacity={0.9} style={stPlayMedia.btnMedia}
                    ...
                    <Image style={nstyles.nIcon20} source={ImagesChat.icRewind} />
                </TouchableOpacity>
                <TouchableOpacity activeOpacity={0.9} style={[stPlayMedia.btnMedia, { marginHorizontal: this.state.isLandscape ? 5 : 20 }]}
                    onPress={this.onPause}>
                    <Image style={[nstyles.nIcon24, { tintColor: 'white' }]} source={this.state.paused ? ImagesChat.icPlay : ImagesChat.icPause} />
                </TouchableOpacity>
                <TouchableOpacity activeOpacity={0.9} style={stPlayMedia.btnMedia}
                    onPress={this.onSeek(10)}>
                    <Image style={nstyles.nIcon20} source={ImagesChat.icForward} />
                </TouchableOpacity>
            </View>
        )
    }
    onPressSend = () => {
        ...
        this.props.SendFileOfGroup([{ ...this.source }]);
        Utils.goback(this)
    }
    onSendVideo = () => {
        this.onSend();
                    ...
                    }} />
                    {
                        this.showClose ?
                            <TouchableOpacity activeOpacity={0.9}
                                ...
                                <Image style={nstyles.nIcon24} source={ImagesChat.icCloseWhite} />
...

                    {
                        this.source == '' || this.isFullScreen ? null :
                            <TouchableOpacity activeOpacity={0.9} style={{ marginLeft: 20 }}
                                ...
                                <Image style={nstyles.nIcon20} source={ImagesChat.icFullScreen} />
                            </TouchableOpacity>
                    }
                </View>
...
export default Utils.connectRedux(PlayVideo, mapStateToProps, true)
