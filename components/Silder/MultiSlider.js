        ...
        return (
            <View style={containerStyle}>
                <View style={[styles.fullTrack, { width: sliderLength }]}>
                    ...
                    {twoMarkers && (<View style={[styles.track, this.props.trackStyle, trackThreeStyle, { width: trackThreeLength }]} />
                    )}
                    <View style={[styles.markerContainer, markerContainerOne, this.props.markerContainerStyle,
                    positionOne > sliderLength / 2 && styles.topMarkerContainer]}>
                        ...
                        {timeLeft == null ? null : <Text style={{ paddingTop: 8, fontSize: 18 }}>{timeLeft}h</Text>}
                    ...
                    {twoMarkers &&
                        positionOne !== this.props.sliderLength && (
                            ...
                            >
                                ...
                                {timeRight == null ? null : <Text style={{ paddingTop: 8, fontSize: 18 }}>{timeRight}h</Text>}
                            </View>
                        )}
                </View>
            </View>
