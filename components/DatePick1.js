...
export default class DatePick1 extends React.PureComponent {
    constructor(props) {
        super(props);
    ...
    // _selectedyear = (item, onValueChangeYear = () => { }) => () => {
    //     yearTemp = item.nam;
    //     this.setState({ dateSelected: { year: yearTemp } });
    //     onValueChangeYear(new Date(yearTemp));
    // }

    render() {
        let { style = {}, onValueChange, format, value, disableDateOld = false, isVisible = false } = this.props;
        ...
        return (
            <TouchableOpacity disabled={isVisible} style={!isVisible ? [{ justifyContent: 'center', alignItems: 'center' }, style] : {}} onPress={this.show}>
                {
                    isVisible ? null :
                    ...
                    <View style={{
                        ...
                        <View style={[stDatePick.containMain]}>
                            ...
                            <View style={[nstyles.nrow, {
                                ...
                                >
                                    <Image style={nstyles.nIcon20} source={ImgComp.btnPre} resizeMode="contain" />
                                </TouchableOpacity>
                                <View style={nstyles.nrow}>
                                ...
                                >
                                    <Image style={nstyles.nIcon20} resizeMode="contain" source={ImgComp.btnNext} />
                                </TouchableOpacity>
                            </View>
