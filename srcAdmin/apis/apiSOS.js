...
async function GetList_TinhTrangAll() {
    const res = await Utils.get_api('api/map-sos/GetList_TinhTrangAll', false, false, true, AppCodeConfig.APP_ADMIN)
    return res;
};
...
async function Info_SOS(Id = '') {
    const res = await Utils.get_api(`api/sos/Info_SOS?Id=${Id}`, false, false, true, AppCodeConfig.APP_ADMIN)
    return res;
};
...
async function Info_SOS_APP(Id = '') {
    ...
    const res = await Utils.get_api(`api/sos/Info_SOS_APP?Id=${Id}&DevicesToken=${DevicesToken}`, false, false, true)
    return res;
};
...
async function DanhSachNguoiDung(IdDonVi = '', IdRole = '') {
    const res = await Utils.get_api(`api/nguoidung/DanhSachNguoiDung?query.filter.keys=DonVi|IdRole&query.filter.vals=${IdDonVi}|${IdRole}`, false, false, true, AppCodeConfig.APP_ADMIN)
    return res;
};

//api/sos/GetList_NhatKyThaoTac?Id=4
async function GetList_NhatKyThaoTac(Id = '') {
    const res = await Utils.get_api(`api/sos/GetList_NhatKyThaoTac?Id=${Id}`, false, false, true, AppCodeConfig.APP_ADMIN)
    return res;
};

//api/sos/Info_SOSDetail?Id=4
async function Info_SOSDetail(Id = '') {
    const res = await Utils.get_api(`api/sos/Info_SOSDetail?Id=${Id}`, false, false, true, AppCodeConfig.APP_ADMIN)
    return res;
};
...
async function TiepNhanSOS(body) {
    ...
    const res = await Utils.post_api(`api/sos/TiepNhanSOS`, strBody, false, false, true, AppCodeConfig.APP_ADMIN)
    return res;
};
...
async function HoanThanhSOS(body) {
    let strBody = JSON.stringify(body)
    const res = await Utils.post_api(`api/sos/HoanThanhSOS`, strBody, false, false, true, AppCodeConfig.APP_ADMIN)
    return res;
};
...
async function ThuHoiSOS(body) {
    let strBody = JSON.stringify(body)
    const res = await Utils.post_api(`api/sos/ThuHoiSOS`, strBody, false, false, true, AppCodeConfig.APP_ADMIN)
    return res;
};

//Xoa SOS api/sos/DeleteSOS/25
async function DeleteSOS(Id = '') {
    const res = await Utils.get_api(`api/sos/DeleteSOS/${Id}`, false, false, true, AppCodeConfig.APP_ADMIN)
    return res;
};
async function ChuyenXuLySOS(body) {
    let strBody = JSON.stringify(body)
    const res = await Utils.post_api(`api/sos/AddEditSOS`, strBody, false, false, true, AppCodeConfig.APP_ADMIN)
    return res;
};
export {
