...
class TKAdminChiTiet extends Component {
    constructor(props) {
        ...
        switch (this.Type) {
            case 1:
                body = {
                    ...
                    "record": 10,
                    "OrderBy": "",
                    "filter.keys": `tungay|denngay|idchuyenmuc|idnhomdonvi|iddonvi|loaidanhgia${this.checkTK == 'false' ? '' : '|ChuyenMucQL'}`,
                    "filter.vals": `${Moment(FromDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${Moment(ToDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${this.LinhVuc}|${this.Values}|${this.IdDonVi}|${this.loaidanhgia}${this.checkTK == 'false' ? '' : '|1'}`,
                }
            ...
            case 2:
                body = {
                    ...
                    "record": 10,
                    "OrderBy": "",
                    "filter.keys": `tungay|denngay|iddonvi|loaidanhgia${this.checkTK == 'false' ? '' : '|ChuyenMucQL'}`,
                    "filter.vals": `${Moment(FromDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${Moment(ToDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${this.IdDonVi}|${this.loaidanhgia}${this.checkTK == 'false' ? '' : '|1'}`,
                }
            ...
            case 3:
                body = {
                    ...
                    "record": 10,
                    "OrderBy": "",
                    "filter.keys": `idaccount|tungay|denngay|iddonvi|loaidanhgia${this.checkTK == 'false' ? '' : '|ChuyenMucQL'}`,
                    "filter.vals": `${this.IdAccount}|${Moment(FromDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${Moment(ToDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${this.IdDonVi}|${this.loaidanhgia}${this.checkTK == 'false' ? '' : '|1'}`,
                }
            ...
            case 4:
                body = {
                    ...
                    "record": 10,
                    "OrderBy": "",
                    "filter.keys": `idaccount|tungay|denngay|idlinhvuc|loaidanhgia|iddonvi${this.checkTK == 'false' ? '' : '|ChuyenMucQL'}`,
                    "filter.vals": `${this.IdAccount}|${Moment(FromDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${Moment(ToDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${this.IdDonVi}|${this.loaidanhgia}|${this.idDonVi}${this.checkTK == 'false' ? '' : '|1'}`,
                }
            ...
            case 5:
                body = {
                    ...
                    "record": 10,
                    "OrderBy": "",
                    "filter.keys": `idaccount|tungay|denngay|idnguon|loaidanhgia${this.checkTK == 'false' ? '' : '|ChuyenMucQL'}`,
                    "filter.vals": `${this.IdAccount}|${Moment(FromDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${Moment(ToDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${this.IdDonVi}|${this.loaidanhgia}${this.checkTK == 'false' ? '' : '|1'}`,
                }
            ...
            case 6:
                body = {
                    ...
                    "record": 10,
                    "OrderBy": "",
                    "filter.keys": `idaccount|tungay|denngay|idchuyenmuc|loaidanhgia${this.checkTK == 'false' ? '' : '|ChuyenMucQL'}`,
                    "filter.vals": `${this.IdAccount}|${Moment(FromDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${Moment(ToDate, 'DD/MM/YYYY').format('DD-MM-YYYY')}|${this.IdDonVi}|${this.loaidanhgia}${this.checkTK == 'false' ? '' : '|1'}`,
                }
    ...
    _renderItem = ({ item, index }) => {
        return (
            <Animatable.View animation={index % 2 == 0 ? 'slideInRight' : 'slideInLeft'} style={{ paddingHorizontal: 10, marginBottom: 5, }}>
                <TouchableOpacity
                    onPress={() => Utils.goscreen(this, "sc_ChiTietPAAdmin",
                        {
                            IdPA: item.IdPA,
                            isMenuMore: -1
                        })}
