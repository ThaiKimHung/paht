...
import { GetList_ThongKePA_TheoNguon } from '../../apis/ThongKeBaoCao'
...
class TKTheoNguonPA extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    getData = async () => {
        ...
        let res = await GetList_ThongKePA_TheoNguon(moment(FromDate, "DD/MM/YYYY").format("DD-MM-YYYY"), moment(ToDate, "DD/MM/YYYY").format("DD-MM-YYYY"), 1);
        ...
        switch (key) {
            case KeyTK.SoLuong:
                Utils.goscreen(this.props.nthis, 'scChiTietTKAdmin', {
                    IdDonVi: IdDV, TuNgay: FromDate, DenNgay: ToDate, loaidanhgia: '0', Type: 5, IdAccount: IdAccount
                })
                break;
            case KeyTK.DaXL_Tong:
                Utils.goscreen(this.props.nthis, 'scChiTietTKAdmin', {
                    IdDonVi: IdDV, TuNgay: FromDate, DenNgay: ToDate, loaidanhgia: '1', Type: 5, IdAccount: IdAccount
                })
                break;
            case KeyTK.DaXL_TrongHan:
                Utils.goscreen(this.props.nthis, 'scChiTietTKAdmin', {
                    IdDonVi: IdDV, TuNgay: FromDate, DenNgay: ToDate, loaidanhgia: '2', Type: 5, IdAccount: IdAccount
                })
                break;
            case KeyTK.DaXL_QuaHan:
                Utils.goscreen(this.props.nthis, 'scChiTietTKAdmin', {
                    IdDonVi: IdDV, TuNgay: FromDate, DenNgay: ToDate, loaidanhgia: '3', Type: 5, IdAccount: IdAccount
                })
                break;
            case KeyTK.DangXL_Tong:
                Utils.goscreen(this.props.nthis, 'scChiTietTKAdmin', {
                    IdDonVi: IdDV, TuNgay: FromDate, DenNgay: ToDate, loaidanhgia: '4', Type: 5, IdAccount: IdAccount
                })
                break;
            case KeyTK.DangXL_TrongHan:
                Utils.goscreen(this.props.nthis, 'scChiTietTKAdmin', {
                    IdDonVi: IdDV, TuNgay: FromDate, DenNgay: ToDate, loaidanhgia: '5', Type: 5, IdAccount: IdAccount
                })
                break;
            case KeyTK.DangXL_QuaHan:
                Utils.goscreen(this.props.nthis, 'scChiTietTKAdmin', {
                    IdDonVi: IdDV, TuNgay: FromDate, DenNgay: ToDate, loaidanhgia: '6', Type: 5, IdAccount: IdAccount
                })
                break;
                            ...
                            <View>
                                ...
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    <View style={{ width: widthColumn(), borderWidth: 0.5, borderBottomWidth: 0, borderRightWidth: 0, borderLeftWidth: 0 }}>
                                        <Text style={[styles.text, { fontWeight: 'bold' }]}>{`Nguồn`}</Text>
                                    </View>
