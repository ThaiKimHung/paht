! function (t, e) {
    ...
    s.prototype.range = function (t, e, o, n) {
        ...
        //công thức tính d, t,e,o t=h.x,e =h.y o = a
    ...
    return p.prototype.load = function (t) {
        // console.log("gia tri data truyền vao", t, this.options)
        var e = this.options,
            o = e.log,
            n = e.minZoom,
            r = e.maxZoom,
        ...
        for (var f = r; f >= n; f--) {
            ...
            //duyệt theo dộ zoom từ cao đến thấp 20->1
            var d = +Date.now();
        ...
        //t là mảng data truyền vào quy đổi dạng rồi 
        //e là cấp zoom 1-20
        for (var o = [], n = this.options, r = n.radius, i = n.extent, s = n.reduce, a = r / (i * Math.pow(2, e)), p = 0;
            ...
            //gán giá trị h bằng tvij trí p của data t
            if (!(h.zoom <= e)) {
