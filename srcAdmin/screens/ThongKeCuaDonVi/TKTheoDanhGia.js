...
export class TKTheoDanhGia extends Component {
    ...
    getData = async () => {
        ...
        nthisIsLoading.show();
        let filterkeys = `tungay|denngay|nhomdv|donvicanhan`;
        let filtervals = `${moment(FromDate, "DD/MM/YYYY").format("DD-MM-YYYY")}|${moment(ToDate, "DD/MM/YYYY").format("DD-MM-YYYY")}|0|true`;
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, flex: 1, paddingBottom: getBottomSpace() }}>
