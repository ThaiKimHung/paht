...
const dataTabSVL = [
    {
        name: "Người tìm việc",
        keySreen: "tab_ViecTimNguoi",
        icon: ImagesSVL.ic_TimViec,
        iconActive: ImagesSVL.ic_TimViecCol
    },
    {
        name: "Ứng tuyển",
        keySreen: "tab_UngTuyen",
        icon: ImagesSVL.ic_ViecUngTuyen,
        iconActive: ImagesSVL.ic_ViecUngTuyenCol
    },
    {
        name: "Hộp thư",
        keySreen: "tab_HomThu",
    ...
    },
    {
        name: "Hồ sơ của tôi",
        keySreen: "tab_HoSo",
        icon: ImagesSVL.ic_HoSoCaNhan,
        iconActive: ImagesSVL.ic_HoSoCaNhanCol
    },
]

class TabarSVL extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    render() {
        ...
        const { CountMailBox = 0 } = this.props.dataSVL
        let tempIndex = index;
        if (index == 0 || index > 4)
            tempIndex = 0;
                                ...
                                }}>{item.name}</Text>
                                {
                                    index2 != 2 ? null :
                                        ...
                                        <View style={{
                                            ...
                                            borderRadius: 10, justifyContent: 'center', alignItems: 'center', minWidth: reSize(15), minHeight: reSize(15),
                                        }}>
                                            <Text style={{
...
const stTabarSVL = StyleSheet.create({
    container: {
        flexDirection: 'row',
...
export default Utils.connectRedux(TabarSVL, mapStateToProps, true);
