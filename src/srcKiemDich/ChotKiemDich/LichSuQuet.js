...
class LichSuQuet extends Component {
    constructor(props) {
        super(props);
    ...
    GetListHistoryScan = async () => {
        ...
        let res = await apis.ApiChotKiem.GetListHistoryScan(text, page.Page, page.Size)
    ...
    goDetails = (item) => {
        if (this.isModal) {
            Utils.goscreen(this, 'Modal_ChiTietLichSu', { data: item })
        } else {
            Utils.goscreen(this, 'CTLichSuQuet', { data: item })
        }
    }
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: colors.white }}>
                <HeaderCus
                    onPressLeft={this.isModal ? () => { Utils.goback(this) } : () => Utils.goscreen(this, 'ManHinh_Home')}
