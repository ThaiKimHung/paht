...
class LichSuQuetChotCho extends Component {
    constructor(props) {
        super(props);
    ...
    GetListHistoryScan = async () => {
        ...
        let res = await apis.ApiChotKiem.GetListHistoryScanMarket(text, page.Page, page.Size, 2)
    ...
    goDetails = (item) => {
        if (this.isModal) {
            ...
            Utils.goscreen(this, 'CTLichSuQuetChotCho', { data: item })
        }
    }
...
export default LichSuQuetChotCho;
