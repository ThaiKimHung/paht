...
const RECORD = 10
class DaGuiTuVanF0 extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        this.getFirstData();
        ROOTGlobal.dataGlobal._onRefreshDaGuiTuVanF0 = this._onRefresh;
    }
    getFirstData = async () => {
        await this.getListDaGuiTuVanF0();
    }

    getListDaGuiTuVanF0 = async () => {
        var {
            daGuiList,
            textempty,
            _page,
        ...
        let res = await apis.ApiPhanAnh.GetDanhSachPAFilterDaGuiTuVanF0(_page, 10, this.props.objectfilter);
        // this.refLoading.current.hide();
        Utils.nlog("DS DaGuiTuVanF0:", res);
    ...
    _renderItem = (item, index) => {
        ...
        return (
            <ItemDanhSach
                ...
                isShare={false}
                goscreen={() => Utils.goscreen(this.nthis, 'Modal_ChiTietTuVanF0', { IdPA: IdPA, TenChuyenMuc: ChuyenMuc })}
    ...
    loadMore = () => {
        ...
        if (_page < _allPage) {
            this.setState({ _page: _page + 1 }, this.getListDaGuiTuVanF0);
        }
    };
...
export default Utils.connectRedux(DaGuiTuVanF0, mapStateToProps, true)
