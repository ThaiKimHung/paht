...
class MapHomeTuVanF0 extends Component {
    // dataitem: data,
    ...
    _getListCongDong = async (more = true) => {
        ...
        let res = await apis.ApiPhanAnh.GetDanhSachTuVanF0('', '', '', '', '', true);
    ...
    _goScreen = (dataItem) => {
        Utils.goscreen(this, 'Modal_ChiTietTuVanF0', { IdPA: dataItem.IdPA, TenChuyenMuc: dataItem.ChuyenMuc || dataItem.LinhVuc })
    }
