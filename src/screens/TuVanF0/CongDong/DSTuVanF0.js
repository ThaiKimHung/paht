...
class DSTuVanF0 extends Component {
    constructor(props) {
        super(props);
        this.yNext = 0
        this.animaDelta = 0
        ...
        this.state = {
            ...
            textempty: 'Đang tải...',
            dataListArea: [],
            itemSelected: { 'MaPX': -1, 'TenPhuongXa': 'Tổng hợp' }
        };
        ROOTGlobal.dataGlobal._onRefreshCongDongTuVanF0 = this._onRefresh
    }
    ...
    GetListTuVanF0 = async () => {
        ...
        let res = await apis.ApiPhanAnh.GetDanhSachTuVanF0(page.Page, page.Size, keyFill, keyVal)
    ...
    goSearch = () => {
        Utils.goscreen(this, 'SearchTuVanF0')
    }
    ...
    _onRefresh = () => {
        this.setState({ page: { Page: 1, AllPage: 1, Size: 10, Total: 0 }, refreshing: true, textempty: 'Đang tải...', dataList: [] }, this.GetListTuVanF0)
    }
    ...
    loadMore = async () => {
        ...
        if (page.Page < page.AllPage) {
            this.setState({ page: { ...page, Page: page.Page + 1 } }, this.GetListTuVanF0)
        }
    }
    ...
    renderItem = ({ item, index }) => {
        ...
        return (
            <ItemDanhSach
                ...
                goscreen={() => Utils.goscreen(this, 'Modal_ChiTietTuVanF0', { IdPA: IdPA, TenChuyenMuc: ChuyenMuc, SoLuongTuongTac: SoLuongTuongTac })}
    ...
    MapView = () => {
        Utils.goscreen(this, 'Modal_MapHomeTuVanF0')
    }
...
export default Utils.connectRedux(DSTuVanF0, mapStateToProps, true)
