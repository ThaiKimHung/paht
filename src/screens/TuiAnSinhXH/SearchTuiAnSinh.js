...
class SearchTuiAnSinh extends Component {
    constructor(props) {
        super(props);
        this.pageAll = 0;
        this.state = {
    ...
    _onSearch = async () => {
        ...
        if (textSearch) {
            this.setState({ refreshing: true }, async () => {
                const res = await apis.ApiPhanAnh.GetDanhSachTuiAnSinh(1, 10, '', '', textSearch);
    ...
    _renderItem = ({ item, index }) => {
        ...
        return <ItemDanhSach
            ...
            goscreen={() => Utils.goscreen(this, 'Modal_ChiTietTuiAnSinh', { IdPA: IdPA, TenChuyenMuc: ChuyenMuc })}
    ...
    loadMore = async () => {
        ...
        if (page < this.pageAll) {
            let res = await apis.ApiPhanAnh.GetDanhSachTuiAnSinh(pageNumber, 10, '', '', textSearch);
                        ...
                        <View style={[nrow, { alignItems: 'center', justifyContent: 'center', paddingBottom: 10, paddingRight: 10 }]}>
                            ...
                            <View style={[nrow, {
                                ...
                                <TextInput
                                    ...
                                    placeholder={'Tìm yêu cầu hỗ trợ túi an sinh...'}
                                    value={textSearch}
...
export default Utils.connectRedux(SearchTuiAnSinh, mapStateToProps, true)