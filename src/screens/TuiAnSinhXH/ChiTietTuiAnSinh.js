...
class ChiTietTuiAnSinh extends Component {
    constructor(props) {
        super(props);
        ...
        this.InterVal;
        ROOTGlobal.dataGlobal._loadDataChiTietTuiAnSinh = (val) => this.setNewData(val)
    }
    setNewData = (IdPA) => {
        this.IdPA = IdPA;
    ...
    _submitComent = async () => {
        ...
        if (this.noidung) {
            ...
            const res = await apis.TuongTac.TuongTacCanBoCongDan_TuiAnSinh(this.IdPA, this.noidung, true, this.state.detailPhanAnh.Status, IdRow, listFileAdd);
            nthisIsLoading.hide();
    ...
    _getListComent = async () => {
        ...
        const res = await apis.TuongTac.DanhSachTuongTac_TuiAnSinh(this.IdPA);
...
export default Utils.connectRedux(ChiTietTuiAnSinh, mapStateToProps)
