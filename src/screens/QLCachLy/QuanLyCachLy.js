...
class QuanLyCachLy extends Component {
    constructor(props) {
        super(props);
        this.state = {
            text: '',
    ...
    getDanhSachCachLyTaiNha = async () => {
        ...
        Utils.nlog("ListCachLyTaiNha:", res)
    ...
    _renderItem = ({ item, index }) => {
        ...
        return (
            <View>
                ...
                <TouchableOpacity onPress={() => this.goDetails(item)} key={index} style={{ backgroundColor: colors.white }}>
        ...
        return (
            <View style={{ flex: 1, backgroundColor: colors.white }}>
                ...
                <View style={{ flex: 1, backgroundColor: colors.white }}>
                    ...
                    <TextInput
                        placeholder="Từ khoá..."
                        style={{ padding: 10, marginHorizontal: 10, marginBottom: 10, backgroundColor: colors.white, borderWidth: 0.5, borderRadius: 5, borderColor: colors.black_40 }}
