...
class ModalFilterHoiDapTT extends Component {
    constructor(props) {
        super(props);
                ...
                <KeyboardAwareScrollView scrollEnabled={false} contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    <View style={stHomeSetting.container}>
                        <TouchableOpacity
                            ...
                            <Image source={Images.icBack} style={[nstyles.nIcon20, { tintColor: colors.peacockBlue }]} resizeMode='contain' />
                        </TouchableOpacity>
...
export default ModalFilterHoiDapTT;
