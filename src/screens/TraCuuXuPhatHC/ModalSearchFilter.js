        ...
        return (
            <View style={{ marginTop: 20, marginHorizontal: 20, flexDirection: 'row' }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 10 }} onPress={() => setTrangThai(1)}>
                        <Image source={trangthai == 1 ? Images.icRadioCheck : Images.icRadioUnCheck} style={{ marginRight: 3 }} />
                        <Text style={{ alignSelf: 'center' }}>Chưa thi hành</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ flexDirection: 'row', marginLeft: 10 }} onPress={() => setTrangThai(2)} >
                        <Image source={trangthai == 2 ? Images.icRadioCheck : Images.icRadioUnCheck} style={{ marginRight: 3 }} />
                        <Text style={{ alignSelf: 'center' }}>Đã thi hành</Text>
                    </TouchableOpacity>
                </View>
            </View>
        )
        ...
        return (
            <View style={{ marginVertical: 20, marginHorizontal: 20, flexDirection: 'row' }}>
                ...
                <TouchableOpacity onPress={() => checkTreHan()}>
                    <Image source={hethan == 1 ? Images.icCheck : Images.icUnCheck} style={{ marginLeft: 10, alignSelf: 'center' }} />
                </TouchableOpacity>
            </View>
        )
    }
